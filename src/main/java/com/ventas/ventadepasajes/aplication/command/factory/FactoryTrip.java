...
public class FactoryTrip {
    ...
    public Trip create(CommandTrip commandTrip){
        return new Trip(commandTrip.getCost(), commandTrip.getSeats_available(), commandTrip.getSeats_sold());
    }

    public Trip update(long id, CommandTrip commandTrip){
        return new Trip(id, commandTrip.getCost(), commandTrip.getSeats_available(), commandTrip.getSeats_sold());
    }
}
